...
module.exports = {
  async up (queryInterface, Sequelize) {
...

    {
        ...
        lng: -84.6459234,
        name: 'Entire villa',
        description: "Ideal villa for resting , surrounded by nature. A magnificent space to celebrate honeymoons, anniversaries or birthdays, or just to disconnect from stress. With a relaxing jacuzzi, hydro massage and hot water, you can enjoy on your totally private terrace, overlooking the garden.",
        price: 160,
        avgRating: 4.94,
